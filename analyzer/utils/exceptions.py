...
class AnalyzerException(Exception):
    """
    Analyzer base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(AnalyzerException):
    """
...
class DependencyException(AnalyzerException):
    """
...
class StrategyError(AnalyzerException):
    """
