...
from analyzer.utils_rpc.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, analyzer) -> None:
        ...
        #     from analyzer.utils.webhook import Webhook
    ...
    #         prots = '\n'.join([p for prot in protections.short_desc()
